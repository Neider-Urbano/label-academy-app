...
const Nav = () => {
  return (
    <nav className="relative w-full flex items-center justify-center bg-gray-100 text-gray-500 hover:text-gray-700 focus:text-gray-700 py-[20px]">
        <div className="w-full flex items-center justify-between max-w-[1170px]">
            ...
            <div className="flex items-center relative ">
                <div className="dropdown relative">
                        <a className=" text-gray-500 hover:text-gray-700 focus:text-gray-700 dropdown-toggle hidden-arrow flex items-center" href="#" id="dropdownMenuButton1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Home
                ...
                <div className="flex items-center relative">
                    ...
                    <a className="text-gray-500 hover:text-gray-700 focus:text-gray-700 pl-[25px]" href="#">
